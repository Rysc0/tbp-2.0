...
class MainScreen:
    def __init__(self):
        ...
        self.button1 = tk.Button(self.root, text="Button 1", command=self.on_button1_click)
        self.button1.grid(row=0, column=0, padx=10, pady=10, sticky="w")

        self.button2 = tk.Button(self.root, text="Button 2", command=self.on_button2_click)
        self.button2.grid(row=1, column=0, padx=10, pady=10, sticky="w")

        self.button3 = tk.Button(self.root, text="Button 3", command=self.on_button3_click)
